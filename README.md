...
|time|project|
|---|---|
|04/2021 - current|**software developer** at an insurance company<br>setup automatic release process (mvn), introduction and coaching of git workflow, quality insurance by using SonarQube in the CI/CD pipeline, refactoring code to reduce SonarQube issues<br>**technologies used**: Java 11, JUnit, OpenShift 4, Jenkins, SonarQube|
